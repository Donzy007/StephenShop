...
using ShephenShop.WebUI.Tests.Mocks;
using StephenShop.Core.Contracts;
using StephenShop.Core.Models;
using StephenShop.Services;
using System.Linq;
...
namespace ShephenShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "donstephco@yahoo.com", ZipCode = "11111" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("donstephco@yahoo.com","Forms"), null);
